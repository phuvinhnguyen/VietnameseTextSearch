...
def create(data):
    ...
    dataframe['neg'] = dataframe['contradiction'] + dataframe['other'] + dataframe['neutral']
    dataframe['pos'] = dataframe['entailment']
    dataframe = dataframe.drop(columns=['entailment', 'contradiction', 'other', 'neutral'])
...
if __name__ == '__main__':
    dataset = construct()
    print(dataset)
    dataset.push_to_hub('ContextSearchLM/ViNLI_reranking', token=None)